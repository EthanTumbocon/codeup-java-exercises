...
//        ArrayLists<Integer> randomNumbers = new ArrayLists()(Arrays.asList(1,2,3));
        ...
        System.out.println(numbers.get(5));  //does not exist in an array of 3
...
//        System.out.println(emptyList.isEmpty());
        ...
        roasts.remove("medium"); // note the different types this .remove removes the specific roast.
        System.out.println(roasts);
        // TODO: Remove the element at index 4. Note the return value here vs. the previous remove method.
        roasts.remove(4); // this .remove is removing the element at index 4
