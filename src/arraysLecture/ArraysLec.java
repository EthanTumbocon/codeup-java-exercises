...
//        System.out.println(Arrays.toString(nums)); //Type@HashcodeOfObject
...
//        }
        ...
        Arrays.fill(testArray, "dogs"); // array.fill method gives every index with the same value.
        ...
        Arrays.fill(numArray, 0, 5, 58); // changes the first four indices to the value of 5.
        ...
        String[] words = {"Mushroom", "Mushroom"};  // array.equals is checking whether or not they are equal and in the same order..
        ...
        String[] twoBadgers = Arrays.copyOf(badgerArray, 2); // returns a new copy of the array and changes the length based on what you give it.
